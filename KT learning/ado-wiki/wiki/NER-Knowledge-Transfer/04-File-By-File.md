...
> `.env` with Azure credentials — see [`08-How-To-Test-Locally`](./08-How-To-Test-Locally.md).
...
➡️ Next: [`05-Worked-Example`](./05-Worked-Example.md) — follow one real query end to end.
