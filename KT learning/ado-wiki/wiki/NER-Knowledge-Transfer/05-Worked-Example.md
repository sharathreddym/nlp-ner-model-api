...
AI call.** That's the fast-path from [`03-Step-By-Step-Flow`](./03-Step-By-Step-Flow.md) in action.

➡️ Next: [`06-All-Diagrams`](./06-All-Diagrams.md) — every diagram collected for quick reference.
