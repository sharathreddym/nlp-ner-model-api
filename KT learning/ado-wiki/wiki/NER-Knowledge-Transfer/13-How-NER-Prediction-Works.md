...
3. **Data/knowledge gaps (not model gaps).** If the answer isn't in the underlying data, perfect NER
   ...
   de-confliction miss, not a model error. See `12-Bug-217995-Zytel-Case-Study`.
...
⬅️ Back to [`NER-Knowledge-Transfer`](../NER-Knowledge-Transfer.md) · related:
[`11-Rule-Based-vs-LLM`](./11-Rule-Based-vs-LLM.md) ·
[`12-Bug-217995-Zytel-Case-Study`](./12-Bug-217995-Zytel-Case-Study.md)
